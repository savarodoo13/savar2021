...
class AccountAsset71Rep(models.TransientModel):
	...
	def get_report(self):
		self.env.cr.execute("""
				CREATE OR REPLACE view account_asset_71_book as ("""+self._get_sql_71(self.fiscal_year_id.date_from,self.period.date_end,self.company_id.id)+""")""")
	...
	def _get_sql_71(self,date_fiscal_year_start,date_period_end,company_id):
		sql = """
